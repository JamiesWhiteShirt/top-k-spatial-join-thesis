...
Fagin et al.~\cite{fagin2003optimal} evaluated various methods for performing top-k queries for aggregation of ranked inputs by monotone aggregate functions.
